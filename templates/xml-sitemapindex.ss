  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <link rel="stylesheet" href="$resourceURL(toastnz/silverstripe-googlesitemaps:css/style.css)" />
      </head>
      <body>
        <div id="content">
          <h1>
          ...
          <p id="Footer" class="expl">Generated by the SilverStripe
            <a href="https://github.com/toastnz/silverstripe-googlesitemaps" target="_blank" title="SilverStripe Google Sitemaps module on Github">Google Sitemaps Module</a>
